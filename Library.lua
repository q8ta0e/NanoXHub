...
local Themes = {
	...
	NanoX = {
		...
		AcrylicBorder = Color3.fromRGB(96, 205, 255),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 40, 40), Color3.fromRGB(40, 40, 40)),
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(96, 205, 255),
		Tab = Color3.fromRGB(120, 120, 120),
		Element = Color3.fromRGB(120, 120, 120),
		ElementBorder = Color3.fromRGB(96, 205, 255),
		InElementBorder = Color3.fromRGB(96, 205, 255),
		...
		DropdownBorder = Color3.fromRGB(96, 205, 255),
		...
		DialogBorder = Color3.fromRGB(96, 205, 255),
...
Creator.Theme = Creator.Theme or "NanoX"
...
function Creator.GetThemeProperty(Property)
	...
	return Creator.Themes.NanoX[Property]
end
		...
		Creator.AddSignal(UserInputService.InputChanged, function(Input)
			...
			then
				...
				local TargetSizeClamped =
					Vector2.new(math.clamp(TargetSize.X, 500, 2048), math.clamp(TargetSize.Y, 320, 2048))
	...
	function Element:New(Config)
		...
		function Toggle:SetValue(Value)
			...
			elseif not Toggle.Value then
				ToggleCircle.ImageTransparency = 1
			end
	...
	function Element:New(Config)
		...
		if Dropdown.Search then
			SearchBar = New("Frame", {
				...
				New("UIStroke", { Name = "Stroke", ApplyStrokeMode = Enum.ApplyStrokeMode.Border, ThemeTag = { Color = "DropdownBorder" } }),
				New("ImageLabel", {
					Image = "rbxassetid://10734943674",
					BackgroundTransparency = 1,
					Size = UDim2.fromOffset(16, 16),
		...
		local function RecalculateListPosition()
			if Dropdown.Search then
				if #Dropdown.Values > 3 then
					DropdownHolderCanvas.Position = UDim2.fromOffset(DropdownInner.AbsolutePosition.X, DropdownInner.AbsolutePosition.Y - 90)
				else
					DropdownHolderCanvas.Position = UDim2.fromOffset(DropdownInner.AbsolutePosition.X, DropdownInner.AbsolutePosition.Y - 45)
				end
			else
				if #Dropdown.Values > 3 then
					DropdownHolderCanvas.Position = UDim2.fromOffset(DropdownInner.AbsolutePosition.X, DropdownInner.AbsolutePosition.Y - 55)
				else
					DropdownHolderCanvas.Position = UDim2.fromOffset(DropdownInner.AbsolutePosition.X, DropdownInner.AbsolutePosition.Y - 10)
				end
			end
		end
		...
		local function RecalculateListSize()
			if Dropdown.Search then
				if #Dropdown.Values > 5 then
					DropdownHolderCanvas.Size = UDim2.fromOffset(ListSizeX, 215)
				else
...
ElementsTable.Colorpicker = (function()
	...
	function Element:New(Config)
		...
		Colorpicker:SetValue(Config.Default)
...
local SaveManager = {} do
	...
	function SaveManager:BuildConfigSection(tab)
		...
		section:AddInput({ Title = "Config name" })
...
local InterfaceManager = {} do
	...
	function InterfaceManager:BuildInterfaceSection(tab)
		...
		local MenuKeybind = section:AddKeybind({ Title = "Minimize Bind", Default = Library.MinimizeKey.Name or Settings.MenuKeybind })
